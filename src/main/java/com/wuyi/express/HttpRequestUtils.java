...
//            defaultHttpClient = new DefaultHttpClient();
            ...
            log.info("返回值：{}", stringBuilder.toString());
     ...
     * @throws Exception
     */
    public static String httpGet(String url, Map<String, Object> params, String authorization, String... resonseCharSet) throws Exception {
//        DefaultHttpClient defaultHttpClient = null;
        BufferedReader bufferedReader = null;
        HttpClient defaultHttpClient = HttpClientBuilder.create().build();
        try {
